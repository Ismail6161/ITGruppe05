...
$dest = "../ITGruppe05/speicherstände/model_start";
...
$directory = realpath("../ITGruppe05/speicherstände/model_start");
$options = array("remove_path" => $directory);
$zip->addPattern("/\.(?:json)$/", $directory, $options);
$zip->close();
}
rename($zipname_gesamt, "../ITGruppe05/speicherstände/model_start/".$zipname_gesamt);
//löscht alle existenten Export-Jsons 
array_map("unlink", glob("../ITGruppe05/speicherstände/model_start/*.json"));
