...
class Snippet {
  ...
  * @return String gibt gepufferten HTML-Output als String zurück
  */
    ...
    public static function selectmenu($objarraylist,$options=[]){
        ...
        ob_start();
        if( $opt["readonly"]===true ||$opt["readonly"]==="true" || $opt["readonly"]==1){ // da es kein readonly für HTML-Select gibt
           // hidden field, damit Wert übertragen wird.
        $attr=   $opt["name"];
        $value=$opt["default"];
        require("includes/getSnippet/hidden.php");
