...
?>
<a href="?task=Speisen" class="ui-btn ui-icon-back ui-btn-icon-notext ui-corner-all" align="right">No text</a>
...
<label><a href="?task=Positionsliste" for="speichern"></label><button type="submit" name="speichern" id="speichern" value="1" >Zur Bestellliste</button>
</div>
</form>
<script>
</script>
